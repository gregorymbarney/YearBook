...
public class Function {
    ...
    //borrowed a lot again from Ferdousur Rahman Shajib
    // www.androstock.com

    private static final String OPEN_WEATHER_MAP_URL =
            "http://api.openweathermap.org/data/2.5/weather?lat=%s&lon=%s&units=imperial";

    private static final String OPEN_WEATHER_MAP_API = "6bc97f6b8b3404b2793d131a94f5190d";
